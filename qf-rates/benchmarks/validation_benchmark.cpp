...
int main() {
  ...
  const auto independent = qf::simulate_swap_exposure(model, swaps, times, 10000, 19, true, 0.0);
  const auto wrong_way = qf::simulate_swap_exposure(model, swaps, times, 10000, 19, true, 20.0);
